...
function InitializeApp() {
    resources = [];
    events = [];
    addinelement = 'scheduler_element';
    ...
    $('#controlAddIn').parent().append(
        '<div id="ajax-loader" style="visibility:hidden;"><img src="' + Microsoft.Dynamics.NAV.GetImageResource('Addins/Schedule/img/i.png') + '"/><span>Please wait...</span></div>'
    );
    ...
    */
    ...
    var initialCss =
        '.dhx_cal_prev_button {background:url("' + Microsoft.Dynamics.NAV.GetImageResource('Addins/Schedule/img/arrow_left.png') + '") no-repeat center center; }' +
        '.dhx_cal_next_button {background:url("' + Microsoft.Dynamics.NAV.GetImageResource('Addins/Schedule/img/arrow_right.png') + '") no-repeat center center; }' +
        '.dhx_cal_event .dhx_footer:hover {background:url("' + Microsoft.Dynamics.NAV.GetImageResource('Addins/Schedule/img/resizing.png') + '") no-repeat center center; }' +
        '.dhx_cal_event:hover .dhx_footer {background:url("' + Microsoft.Dynamics.NAV.GetImageResource('Addins/Schedule/img/resizing.png') + '") no-repeat center center; }' +
        '.div.dhx_menu_head, div.dhx_menu_icon {background-image:url("' + Microsoft.Dynamics.NAV.GetImageResource('Addins/Schedule/img/controls.png') + '"); }' +
        'div.sub_item_text {font-size: 1em !important;}' +
        //'.dhx_cal_event_line .dhx_event_resize:hover {background:url("' + Microsoft.Dynamics.NAV.GetImageResource('Addins/Schedule/img/resize_dots.png') + '") repeat-y;}' +
        //'.dhx_cal_event_line:hover .dhx_event_resize {background:url("' + Microsoft.Dynamics.NAV.GetImageResource('Addins/Schedule/img/resize_dots.png') + '") repeat-y;}' +
...
function DrawCalendar(calendarElement) {
    ...
    */
    ...
    scheduler.ignore_timelineday = function (date) {
        if (date.getHours() < start_dt_hour || (date.getHours() > end_dt_hour)) return true;
    };
