page 25006444 "Order Promising Lines EDMS"
{
    ...
    begin
        SalesAvailabilityMgt.SetSalesHeader(Rec, CrntSalesHeader, captiontext);
    ...
    begin
        ServAvailabilityMgt.SetServiceHeader(Rec, CrntServHeader, captiontext);
    ...
    begin
        JobPlanningAvailabilityMgt.SetJob(Rec, CrntJob, captiontext);
