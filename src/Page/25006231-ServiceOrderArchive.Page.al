Page 25006231 "Service Order Archive EDMS"
{
    // 23.02.2015 EDMS P21
    //   Added field:
    //     "Model Version No."
        ...
        area(content)
        {
            group(General)
            {
                ...
                group(WorkDescription)
                {
                    ...
                    field(Control25006001; WorkDescription)
                    {
            ...
            part(ServiceLinesArchive; "Service Order Arch. Subform")
            {
                ApplicationArea = All;
            ...
            group(ServiceAddress)
            {
                ...
                field(Control25006005; Rec."Service Address")
                {
                    ApplicationArea = Basic;
                }
            }
