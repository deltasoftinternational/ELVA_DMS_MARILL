page 25006533 "Vehicle Order Processor RC"
{
    Caption = 'Vehicle Sales Order Processor';
    PageType = RoleCenter;
    ...
    actions
    {
        ...
        area(sections)
        {
            ...
            group(Action63)
            {
                ...
                action("Vehicle Requisition Worksheet")
                {
                    ApplicationArea = All;
                    Caption = 'Vehicle Requisition Worksheet';
                    RunObject = Page "Vehicle Req. Worksheet";

                }
            }
            group(VehicleCatalogues)
            {
                Caption = 'Catalogues';
                action(Makes)
                {
