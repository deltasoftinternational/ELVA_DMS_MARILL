Page 25006378 "Items by Location Matrix EDMS"
{
    ...
    procedure FillData(SourceType: Integer; SourceSubType: Integer; SourceID: Code[20])
    var
        ...
        case SourceType of
            ...
            Database::"Service Header EDMS":
                begin
                    ...
                    ServiceLineEDMS.SetRange(Type, SalesLine.Type::Item);
                    if ServiceLineEDMS.FindSet then
                        repeat
                            AddLine(ServiceLineEDMS."No.");
    ...
    local procedure AddLine(ItemNo: Code[20])
    var
        Item: Record Item;
    begin
        if Item.Get(ItemNo) then begin
            if not Rec.Get(ItemNo) then begin
                Rec := Item;
                Rec.Insert;
            end;
        end;
