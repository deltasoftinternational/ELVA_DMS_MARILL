Table 25006382 "Option Sales Price"
{
    ...
    LookupPageID = "Option Sales Prices";
    ...
    fields
    {
        ...
        field(130; "VAT Bus. Posting Gr. (Price)"; Code[20])
        {
    ...
    keys
    {
        key(Key1; "Make Code", "Model Code", "Model Version No.", "Option Type", "Option Subtype", "Option Code", "Sales Type", "Sales Code", "Starting Date", "Currency Code", "Vendor No.")
        {
            Clustered = true;
        }
    }
