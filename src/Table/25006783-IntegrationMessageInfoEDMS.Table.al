Table 25006783 "Integration Message Info EDMS"
{
    ...
    fields
    {
        ...
        field(100; Type; Option)
        {
            Caption = 'Type';
            DataClassification = ToBeClassified;
            OptionCaption = ' ,Error,Warning,Change,Info';
            OptionMembers = " ",Error,Warning,Change,Info;

            trigger OnValidate()
            begin
                "Disable Deleting" := Type in [Type::Change, Type::Info];
            end;
        }
        field(110; Text; Text[250])
        {
            Caption = 'Text';
            DataClassification = ToBeClassified;
        }
        field(120; "Disable Deleting"; Boolean)
        {
            Caption = 'Disable Deleting';
            DataClassification = ToBeClassified;
        }
    ...
    trigger OnInsert()
    var
        Rec2: Record "Integration Message Info EDMS";
    begin
