tableextension 25006035 "Sales Cr.Memo Header" extends "Sales Cr.Memo Header" //114
{
    ...
    fields
    {
        ...
        field(25006682; "BLS Leasing Schedule No."; Code[20])
        {
            Caption = 'BLS Leasing Schedule No.';
    ...
    keys
    {
        ...
        key(Key11; "Vehicle Serial No.")
        {
        }
        key(Key12; "Service Return Order No.", "Service Document")
        {
        }
    }
    ...
    begin
        Clear(cuVFMgt);
        exit(cuVFMgt.IsVFActive(Database::"Sales Cr.Memo Header", intFieldNo));
    end;
