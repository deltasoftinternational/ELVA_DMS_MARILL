Report 25006015 "Sales Orders by Makes R11"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/SalesOrdersbyMakesR11.rdlc';
    Caption = 'Sales Orders by Makes';
    ...
    labels
    {
        ReportTitleLbl = 'Sales Orders by Makes';
    }
