Report 25006003 "Service Orders by Models R02"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/ServiceOrdersbyModelsR02.rdlc';
    Caption = 'Service Orders by Models';
    ...
    labels
    {
        ReportTitleLbl = 'Service Orders by Models';
    }
