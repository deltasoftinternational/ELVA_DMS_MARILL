Report 25006021 "Serv. Ret. Ord. by Models R17"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/ServRetOrdbyModelsR17.rdlc';
    Caption = 'Service Return Orders by Models';
    ...
    labels
    {
        ReportTitleLbl = 'Service Return Orders by Models';
    }
