Report 25006018 "Sales Orders by Locations R14"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/SalesOrdersbyLocationsR14.rdlc';
    Caption = 'Sales Orders by Locations';
    ...
    labels
    {
        ReportTitleLbl = 'Sales Orders by Locations';
    }
