Report 25006016 "Sales Orders by Models R12"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/SalesOrdersbyModelsR12.rdlc';
    Caption = 'Sales Orders by Models';
    ...
    labels
    {
        ReportTitleLbl = 'Sales Orders by Models';
    }
