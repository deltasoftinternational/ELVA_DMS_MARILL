Report 25006024 "Serv.Ret.Ord. by Customers R20"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/ServRetOrdbyCustomersR20.rdlc';
    Caption = 'Service Return Orders by Customers';
    ...
    labels
    {
        ReportTitleLbl = 'Service Return Orders by Customers';
    }
