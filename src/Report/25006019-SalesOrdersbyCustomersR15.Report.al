Report 25006019 "Sales Orders by Customers R15"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/SalesOrdersbyCustomersR15.rdlc';
    Caption = 'Sales Orders by Customers';
    ...
    labels
    {
        ReportTitleLbl = 'Sales Orders by Customers';
    }
