Report 25006025 "Vehicle Sales - Invoice"
{
    ...
    //   * Added request page
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/VehicleSalesInvoice.rdlc';
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem("Sales Invoice Line"; "Sales Invoice Line")
                    {
                        ...
                        column(MakeCode_SalesInvLine; "Sales Invoice Line"."Make Code")
                        {
                            IncludeCaption = true;
                        }
                        column(ModelCode_SalesInvLine; "Sales Invoice Line"."Model Code")
                        {
                            IncludeCaption = true;
                        }
                        column(VIN_SalesInvLine; "Sales Invoice Line".VIN)
                        {
                            IncludeCaption = true;
                        }
                                ...
                                case ShowPicture of
                                    Showpicture::"Model Version":
                                        begin
                                            ...
                                            PictureTbl.SetRange("Source ID", "Sales Invoice Line"."No.");
                                    ...
                                    Showpicture::Vehicle:
                                        begin
                                            ...
                                            PictureTbl.SetRange("Source ID", "Sales Invoice Line"."Vehicle Serial No.");
                                            PictureTbl.SetRange("Source Ref. No.", 0); // Not used
                                        end;
