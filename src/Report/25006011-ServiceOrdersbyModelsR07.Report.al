Report 25006011 "Service Orders by Models+ R07"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/ServiceOrdersbyModelsR07.rdlc';
    Caption = 'Posted Service Orders by Models';
    ...
    labels
    {
        ReportTitleLbl = 'Posted Service Orders by Models';
    }
