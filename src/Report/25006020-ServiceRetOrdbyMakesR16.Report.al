Report 25006020 "Service Ret. Ord. by Makes R16"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/ServiceRetOrdbyMakesR16.rdlc';
    Caption = 'Service Orders by Makes';
    ...
    labels
    {
        ReportTitleLbl = 'Service Orders by Makes';
    }
